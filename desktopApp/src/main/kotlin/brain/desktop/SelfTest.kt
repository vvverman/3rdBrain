...
object SelfTest {
    suspend fun run(resources: Path, output: Path, fixture: Path) {
        ...
        try {
            ...
            // Реальный нативный журнал: восстановление после выхода, без запроса физического микрофона.
            ...
            // Отменяем очередь для тестового тихого звука; оригинал уже сохранён.
            ...
            val report = buildJsonObject {
                ...
                put("javaHome", System.getProperty("java.home")); put("resources", resources.toString())
