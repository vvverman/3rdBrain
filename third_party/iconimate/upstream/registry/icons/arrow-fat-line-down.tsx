...
//
// Exact Phosphor arrow-fat-line-down; the artwork is untouched and the rest state is the original
...
export const ArrowFatLineDownIcon = makeArrowTravel(ARROW, "down");
