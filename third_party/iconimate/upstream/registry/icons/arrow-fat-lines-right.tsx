...
//
// Exact Phosphor arrow-fat-lines-right; the artwork is untouched and the rest state is the original
...
export const ArrowFatLinesRightIcon = makeArrowTravel(ARROW, "right");
