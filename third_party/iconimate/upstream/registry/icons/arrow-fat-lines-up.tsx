...
//
// Exact Phosphor arrow-fat-lines-up; the artwork is untouched and the rest state is the original
...
export const ArrowFatLinesUpIcon = makeArrowTravel(ARROW, "up");
