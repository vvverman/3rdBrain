...
// TRAVEL — the arrow goes where it points. It accelerates off the bottom edge, and while
// it is genuinely off-frame it is repositioned above the box and eases back down to rest.
...
// The glyph spans y32..230 (shaft round-join to arrowhead cap). +232 puts its trailing
// edge at 264 and -236 puts its leading edge at -6, so it is fully invisible at BOTH ends
