...
// LEVEL UP — the meter charges from empty. This is the half cell (TWO bars at
// x-centers 56/96). Each bar resets to nothing, then pops up from the base in
// turn, left → right, with an overshoot as it lands.
//
...
export const BatteryMediumIcon = forwardRef<IconHandle, IconProps>(
  function BatteryMediumIcon({ size = 28, style, ...props }, ref) {
