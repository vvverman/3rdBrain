...
with sync_playwright() as pw:
    ...
    try:
        ...
        page.get_by_text('Задача',exact=True).click();click('button',re.compile('^Твой первый проект'));button('Сохранить задачу')
        ...
        page.get_by_text('А-Я',exact=True).click();wait(lambda:task_y('Альфа задача') < task_y('Бета задача'),'алфавитная сортировка задач')
        page.get_by_text('Создано',exact=True).click();wait(lambda:task_y('Бета задача') < task_y('Альфа задача'),'сортировка задач по созданию')
        page.get_by_text('Изменено',exact=True).click();wait(lambda:task_y('Бета задача') < task_y('Альфа задача'),'сортировка задач по изменению')
        page.get_by_text('Вручную',exact=True).click();wait(lambda:task_y('Альфа задача') < task_y('Бета задача'),'исходный ручной порядок задач')
        ...
        page.get_by_text('А-Я',exact=True).click();wait(lambda:task_y('Альфа задача') < task_y('Бета задача'),'переключение с Manual')
        page.get_by_text('Вручную',exact=True).click();wait(lambda:task_y('Бета задача') < task_y('Альфа задача'),'восстановление ручного порядка задач')
